...
/// unit-tested without standing up either hosting runtime — each endpoint adapter is a thin wrapper
...
/// real client. Response adapters use explicit wire-format annotations for the same reason.
/// </para>
/// </summary>
public sealed record RegistrationRequest(
    [property: JsonPropertyName("redirect_uris")] string[]? RedirectUris,
    [property: JsonPropertyName("client_name")] string? ClientName,
    [property: JsonPropertyName("application_type")] string? ApplicationType = null);
