...
public sealed class DevBrainJwtIssuerOptions
{
    ...
    /// <summary>
    /// JWT <c>aud</c> claim. <b>Must</b> be the host's complete MCP resource URL
    /// (for example, <c>{base_url}/mcp</c>), not the base URL.
...
/// <c>/token</c>; host-specific authentication middleware validates them on every tool call.
///
/// <para>Design:</para>
/// <list type="bullet">
